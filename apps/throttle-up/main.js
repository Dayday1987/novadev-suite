...
const CONFIG = {
  ...
  // Wheelie mechanics
  torque: 0.002, // added 13 Rotational force applied during wheelie (stronger for sustained wheelies)
  torqueSpeedMult: 0.002, // added 10 Speed-dependent torque multiplier
  gravity: 0.028, // added 15 Gravity force pulling towards balance (weaker for longer wheelies)
  damping: 0.97, // added 5 Angular velocity damping
